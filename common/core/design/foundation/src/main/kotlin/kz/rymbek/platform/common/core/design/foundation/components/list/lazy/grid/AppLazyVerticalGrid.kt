...
import kz.rymbek.platform.common.core.design.foundation.constants.PlatformItemWidth
import kz.rymbek.platform.common.core.design.foundation.constants.PlatformPaddings

@Composable
fun AppLazyVerticalGrid(
    modifier: Modifier = Modifier,
    columns: GridCells = GridCells.Adaptive(minSize = PlatformItemWidth.medium),
