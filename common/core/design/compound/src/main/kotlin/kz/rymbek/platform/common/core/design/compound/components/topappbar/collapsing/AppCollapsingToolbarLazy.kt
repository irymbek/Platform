package kz.rymbek.platform.common.core.design.compound.components.topappbar.collapsing
...
import kz.rymbek.platform.common.core.design.foundation.components.topappbar.AppTopAppBar
...
private fun rememberHeaderSize(
    ...
    return remember(windowInfo.containerSize, portraitRatio, landscapeRatio, density) {
        ...
        val headerDp = if (wPx == 0 || hPx == 0) {
            ...
            with(density) {
                if (wPx < hPx) {
                    wPx.toDp() * portraitRatio
                } else {
                    hPx.toDp() * landscapeRatio
                }
            }
        }
