...
fun List<ValidationError>.errorAt(path: KProperty1<*, *>): String? = messagesAtPath(path).firstOrNull()

fun List<ValidationError>.errorAt(
    parent: KProperty1<*, *>,
    index: Int,
    child: KProperty1<*, *>,
): String? = this.messagesAtPath(parent, index, child).firstOrNull()

fun List<ValidationError>.errorAt(parent: KProperty1<*, *>, child: KProperty1<*, *>): String? = this.messagesAtPath(parent, child).firstOrNull()
